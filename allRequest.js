      ...
      if (response.config.params.riotId != "") {
                      ...
                      if (ranked.data[i] != undefined) {
                        switch (ranked.data[i].queueType) {
                          case "RANKED_SOLO_5x5":
                            ...
                            rankedStats.innerHTML = `${queueSolo} ${
                              ranked.data[i].tier
                            } ${ranked.data[i].rank}<br>Vitorias: ${
                              ranked.data[i].wins
                            } <br>Derrotas: ${
                              ranked.data[i].losses
                      ...
                      if (ranked.data[i] != undefined) {
                        switch (ranked.data[i].queueType) {
                          case "RANKED_FLEX_SR":
                            ...
                            rankedFlexData.innerHTML = `${queueFlex} ${
                              ranked.data[i].tier
                            } ${ranked.data[i].rank}<br>Vitorias: ${
                              ranked.data[i].wins
                            } <br>Derrotas: ${
        ...
        axios
          ...
          .then((response) => {
            ...
            axios
              .get("http://localhost:4000/matchHistory", {
                params: { matches: matchI },
              })
              .then((response) => {
                var matchHistoryContainer = document.getElementById(
                  "matchHistoryContainer"
                );
                matchHistoryContainer.style.display = "grid";
                for (
                  let matchIndex = 0;
                  matchIndex < response.data.length;
                  matchIndex++
                ) {
                  var matchDiv = document.getElementById(
                    `match${matchIndex + 1}`
                  );
                  var participants =
                    response.data[matchIndex].info.participants;
                    ...
                    if (participants[participantIndex].puuid === puuid) {
                        ...
                        .then((response) => {
                          ...
                          axios
                            ...
                            .then((response) => {
                              ...
                              const gameMainRune =
                                participants[participantIndex].perks.styles[0]
                                  .selections[0].perk;
                              const gameSecondaryRune =
                                participants[participantIndex].perks.styles[1]
                                  .style;
                              for (let x = 0; x < 5; x++) {
                                ...
                                for (let c = 0; c < 4; c++) {
                                  let runeData4 =
                                    response.data[2].slots[0].runes[c].id;
                                  if (gameMainRune == 8010) {
                                    runeData4 =
                                      response.data[2].slots[0].runes[3].icon;
                                    ...
                                    gameMainRuneIcon.style.border =
                                      "2px solid #d4af37";

                                    gameMainRuneIcon.style.borderRadius =
                                      "15px";
                                  ...
                                  if (gameSecondaryRune == runeData2) {
                                    ...
                                    gameSecondaryRuneIcon.style.height =
                                      " 15px";
                                    gameSecondaryRuneIcon.style.float = "left";
                                    gameSecondaryRuneIcon.style.marginTop =
                                      " 30px";
                                    gameSecondaryRuneIcon.style.marginLeft =
                                      "2px";
                                    gameSecondaryRuneIcon.style.padding =
                                      "2px 2px 2px 2px";
                                    gameSecondaryRuneIcon.style.border =
                                      "2px solid #d4af37";
                                    gameSecondaryRuneIcon.style.borderRadius =
                                      "15px";
                                ...
                                for (let y = 0; y < 3; y++) {
                                  runeData =
                                    response.data[x].slots[0].runes[y].id;
                                  if (gameMainRune == runeData) {
                                    runeData =
                                      response.data[x].slots[0].runes[y].icon;
                                    gameMainRuneIcon.style.width = " 25px";
                                    gameMainRuneIcon.style.height = " 25px";
                                    gameMainRuneIcon.style.float = "left";
                                    gameMainRuneIcon.style.marginTop = " 25px";
                      ...
                      axios
                        ...
                        .then((response) => {
                          ...
                          const matchItemIcons = Array.from({ length: 6 }, () =>
                            document.createElement("img")
                          );
                          ...
                          const matchItems = Object.values(
                            pick(participants[participantIndex], [
                              "item0",
                              "item1",
                              "item2",
                              "item3",
                          ...
                          for (let x = 0; x < 6; x++) {
                            var itemFound = itemData.find(
                              (item) => item.id == matchItems[x]
                            );
                            if (itemFound) {
                      ...
                      const championId =
                        participants[participantIndex].championId;
