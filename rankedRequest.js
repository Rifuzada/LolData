...
export async function rankedRequest(
    ...
    let response = await axios
        .get("https://rifuzada.github.io/LolData/account", { params: { riotId } })
    if (response.config.params.riotId != "") {
        ...
        let profileresponse = await axios
            .get("https://rifuzada.github.io/LolData/profile", {
                params: { puuid, region },
            })
        ...
        let ranked = await axios
            .get("https://rifuzada.github.io/LolData/ranked", {
                params: { sumID, region },
            })
                        ...
                        switch (ranked.data[i].queueType) {
                            case "RANKED_SOLO_5x5":
                                ...
                                rankedStats.innerHTML = `${queueSolo} ${ranked.data[i].tier
                                    ...
                                    } - Winrate: ${winrateSoloq.toFixed()}%<br>Pontos de liga: ${ranked.data[i].leaguePoints}`;
                                if (i == 0) {
                        ...
                        switch (ranked.data[i].queueType) {
                            case "RANKED_FLEX_SR":
                                ...
                                rankedFlexData.innerHTML = `${queueFlex} ${ranked.data[i].tier
                                    ...
                                    } - Winrate: ${winrateFlex.toFixed()}%<br>Pontos de liga: ${ranked.data[i].leaguePoints}`;
                                if (i == 0) {
                                    if (ranked.data[i + 1] == undefined) {
                                        switch (ranked.data[i + 1]) {
                                            case undefined:
