        ...
        <div>
            <div id="generalContainer">
                <div id="icon">
                    ...
                    <div id="containerRanked">
                        <div id="containerRankedSoloq">
                            ...
                            <span id="rankedSoloqData">Ranqueada Solo/Duo: {eloSoloq}<br />Vitorias: {winsSoloq}<br /> Derrotas: {losesSoloq} - Winrate:{winrateSoloq?.toFixed()}% PDL: {lpSoloq}</span>
                        </div>
                        <br />
                        <div id="containerRankedFlex">
                            ...
                            <span id="rankedFlexData">Ranqueada Flexível: {eloFlex}<br />Vitorias: {winsFlex}<br /> Derrotas: {losesFlex} - Winrate:{winrateFlex?.toFixed()}% PDL: {lpFlex}</span>
                        </div>
                    </div>
                    <div id="containerMastery">
                        {championMastery.map((champion, index) => (
                            <div key={index} id={`containerMasteries${index + 1}`}>
                                <img
                ...
                <div id="matchHistoryContainer">
                    <div id="match1" className="matches"><div className="items"></div></div>
                    <div id="match2" className="matches"><div className="items"></div></div>
                    <div id="match3" className="matches"><div className="items"></div></div>
                    <div id="match4" className="matches"><div className="items"></div></div>
                    <div id="match5" className="matches"><div className="items"></div></div>
                    <div id="match6" className="matches"><div className="items"></div></div>
                    <div id="match7" className="matches"><div className="items"></div></div>
                    <div id="match8" className="matches"><div className="items"></div></div>
                    <div id="match9" className="matches"><div className="items"></div></div>
                    <div id="match10" className="matches"><div className="items"></div></div>
                </div>
            </div>
        </div>
    );
